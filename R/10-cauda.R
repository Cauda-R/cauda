...
#     established, quote
# NOTE: cauda.extract() and cauda.extract_pdf() have been moved to R/02-claims-extraction.R
# and significantly improved with GPT-4-turbo, better prompting, and structured evidence extraction
